...
class Listing(models.Model):
    ...
    photo_1 = CloudinaryField('image1', blank=True)
    photo_2 = CloudinaryField('image2', blank=True)
    photo_3 = CloudinaryField('image3', blank=True)
    photo_4 = CloudinaryField('image4', blank=True)
    photo_5 = CloudinaryField('image5', blank=True)
    photo_6 = CloudinaryField('image6', blank=True)
